...
class twoStreamAttentionModel(nn.Module):
    def __init__(self, flow_model_path=None, rgb_model_path=None, seq_len_flow=5, mem_size=512, num_classes=61, join_method="average"):
        ...
        self.rgb_model = attentionModel(num_classes, mem_size)
